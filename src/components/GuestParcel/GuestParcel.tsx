...
import GuestParcelForm from "./GuestParcelForm";
...
const GuestParcel = () => {
  ...
  const [senderDivision, setSenderDivision] = useState("Dhaka");
  const [senderDistrict, setSenderDistrict] = useState("Dhaka");
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          >
            ...
            <GuestParcelForm
              ...
              setSenderDivision={setSenderDivision}
              senderDistrict={senderDistrict}
              setSenderDistrict={setSenderDistrict}
            />
          </motion.div>
