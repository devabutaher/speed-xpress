    ...
    <div className="container-xl py-10 lg:py-16">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-3xl space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <p>
          ...
          address, phone number, shipping address, and payment information when you
          create an account or place an order. We also automatically collect certain
        ...
        <p>
          ...
          communicate with you about your shipments, improve our services, and send
          you relevant updates and promotional materials (with your consent).
        </p>
        ...
        <p>
          ...
          third parties such as delivery partners, payment processors, and service
          providers who help us operate our platform, subject to strict confidentiality
          agreements.
        </p>
        ...
        <p>
          ...
          secure data storage, and regular security audits to protect your personal
        ...
        <p>
          ...
          any time. You can manage your data through your account settings or by
          contacting us directly. You may also opt out of marketing communications
          at any time.
        </p>
